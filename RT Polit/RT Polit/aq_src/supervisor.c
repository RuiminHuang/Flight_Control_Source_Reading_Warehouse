...
//                }
        ...
        // calculate idle time
        supervisorData.idlePercent = (counter - lastAqCounter) * minCycles * 100.0f / ((1e6f / SUPERVISOR_RATE) * 600/*rccClocks.SYSCLK_Frequency / 1e6f*/);
        ...
        if (!(supervisorData.state & STATE_LOW_BATTERY1) && supervisorData.vInLPF < (p[SPVR_LOW_BAT1]*analogData.batCellCount)) {
            ...
            // TODO: something
            //setLowBattery1Misson();//jiezhi320
        }
            ...
            // TODO: something
           // setLowBattery2Misson();//jiezhi320
        }
