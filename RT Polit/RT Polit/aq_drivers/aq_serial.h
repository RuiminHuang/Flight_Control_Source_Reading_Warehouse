...
#define SERIAL_DEFAULT_RX_BUFSIZE	512
...
extern serialPort_t *serialOpen(char *serial_name, unsigned int baud, uint16_t flowControl, unsigned int rxBufSize, unsigned int txBufSize);
